...
Verify Swift UI changes with [agent-swift](https://github.com/beastoin/agent-swift): use `snapshot -i`, prefer `click` for SwiftUI, and refresh references after interactions. Never automate production bundles.
